...
class plxToken
{
    public const TEMPLATE = 'abcdefghijklmnpqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ';
    public const TEMPLATE_LENGTH = 61; // strlen(self::TEMPLATE);
    public const LIFETIME = 3600; // seconds
