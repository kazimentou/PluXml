...
$LANG = array(
		...
		'L_CONFIRM_DELETE' => 'Löschen bestätigen?',
		...
		'L_FILE_REQUIRED' => 'Bitte auswählen einer Datei',

		'L_REPLY' => 'Antworten',
		'L_REPLY_TO' => 'Antworten',
		'L_CANCEL' => 'Abbrechen',
		...
		'L_THUMBNAIL_ALT' => 'Alternativtext des Bildes (optional)',
		...
		'L_SAVE_ERR' => 'Fehler während des Speicherns',
		'L_NO_ENTRY' => 'Datenzugriff verboten',
		'L_ERR_USER_EMPTY' => 'Bitte Benutzernamen eingeben',
		'L_ERR_PASSWORD_EMPTY' => 'Bitte ein Passwort eingeben',
		...
		'L_ERR_INVALID_ARTICLE_IDENT' => 'Ungültige Artikel-ID!',
		...
		'L_PLXMEDIAS_NEW_FOLDER_SUCCESSFUL' => 'Ordner erfolgreich angelegt',
		...
		'L_PLXMEDIAS_DELETE_FILES_SUCCESSFUL' => 'Dateien wurden erfolgreich entfernt',
		...
		'L_POWERED_BY' => 'Generiert von <a href="https://www.pluxml.org">PluXml</a>',
		...
		'L_MEDIAS_MAX_UPLOAD_FILE' => 'Maximale Größe der Datei',
		'L_MEDIAS_MAX_UPLOAD_NBFILE' => 'Maximale Anzahl an Dateien pro upload',
		'L_MEDIAS_MAX_POST_SIZE' => 'Maximale Datengröße',
		...
		'L_CONFIG_ADVANCED_SMTP_PASSWORD_HELP' => 'Mot de passe de l\'utilisateur sur l\'hôte SMTP',
		'L_CONFIG_ADVANCED_SMTP_PORT_HELP' => 'Numéro du port de l\'hôte SMTP (par défaut : 465)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'PluXml permet de générer des tokens uniquement pour le service <a href="https://cloud.google.com">GMAIL de Google</a>.<br>Besoin d\'aide pour générer l\'identifiant et la clés secrete : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentation de PluXml</a>&nbsp;(fr)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL_HELP' => 'Adresse utilisée sur le service OAUTH2 (exemple : pluxml@gmail.com)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_CLIENTID_HELP' => 'Identifiant client sur le service OAUTH2 (exemple : 664335625964-uha1vop20qPluXml81ubjkkgfabbbj6d.apps.googleusercontent.com)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_SECRETKEY_HELP' => 'La clé du client sur le service OAUTH2 (exemple : PrsvKp6aprKpoP8snnCoC8-x)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN_HELP' => 'Enregistrer l\'ID client et le code secret du client afin de pouvoir générer le token.',
		...
		'L_MAIL_TEST' => 'Senden Sie eine E-Mail zum Testen',
		'L_MAIL_TEST_SUBJECT' => 'E-Mail wird an gesendet %s',
		'L_MAIL_TEST_SENT_TO' => 'Email an gesendet %s. Überprüfen Sie Ihre Mailbox',
		'L_MAIL_TEST_FAILURE' => 'Problem beim Senden einer E-Mail',
		...
		'L_PLUGIN_NO_CONFIG' => 'Plugin nicht konfiguriert',
