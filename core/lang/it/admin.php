...
const L_CONFIRM_ACTIVATE = 'Attivare 999 elementi?';
const L_CONFIRM_DEACTIVATE = 'Disabilitare 999 elementi?';
...
const L_AWAITING = 'Per convalidare';
...
const L_LASTLOGIN_TIMESTAMP = 'Data dell\'ultimo accesso';
...
const L_NEW_PASSWORD = 'nuova password';
const L_LOST_PASSWORD_LOGIN = 'Accesso';
const L_NEW_PASSWORD_SUCCESS = 'Una nuova password ti è stata inviata al %s';
...
const L_BACK_TO_CATEGORIES = 'Ritorna alla lista delle categorie';
...
const L_COMMENT_ARTICLE_LINKED_TITLE = 'AModifica l\'articolo collegato a questo comment';
const L_COMMENT_OFFLINE = 'disabilitato';
const L_COMMENT_ONLINE = 'attivo';
const L_COMMENT_OFFLINE_COUNT = '%d commenti da convalidare';
const L_COMMENT_ONLINE_COUNT = '%d commenti pubblicati';
...
const L_COMMENT_REPLY_TITLE = 'Rispondi a questo commento';

// comments.php

const L_COMMENTS_GLOBAL_SCOPE = 'sito intero';
const L_COMMENT_ALL_FEEDS = 'Messaggio';
...
const L_COMMENTS_ARTICLE = 'Elenco dei commenti per l\'articolo';
const L_COMMENT_SET_ONLINE = 'Carica';
const L_BACK_TO_ARTICLE = 'Torna all\'articolo';
...
const L_BROWSE = 'Navigare';
const L_DEPOSIT_FILES = 'Trascina i tuoi file qui';
const L_FILES = 'File';
const L_BATCH_SIZE = 'Dimensione del lotto';
...
const L_REQUIRED_TARGET = 'Seleziona un altro obiettivo';
...
const L_CONFIG_VIEW_PLUXML_RESSOURCES = 'Scarica più temi';
...
const L_CONFIG_CUSTOM_CSSADMIN_PATH_HELP = 'Specifica il percorso completo dalla homepage';
...
const L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP = 'PluXml ti consente di generare token solo per il servizio GOOGLE.';
...
const L_WARNING_INSTALLATION_FILE = 'Il file install.php è presente nella radice del tuo PluXml.n Per motivi di sicurezza, <a class="lnkdelete" href="?del=install">cancellalo</a>!';
