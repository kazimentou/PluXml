...
$LANG = array(
		...
		'L_FILE_REQUIRED' => 'Si prega di selezionare un file',
		'L_REPLY' => 'Rispondere',
		'L_REPLY_TO' => 'Rispondere',
		'L_CANCEL' => 'Annullare',
		'L_DELETE' => 'Cancella',
		...
		'L_THUMBNAIL_TITLE' => 'Immagine Titolo (facoltativo)',
		'L_THUMBNAIL_ALT' => 'Testo alternativo dell\'immagine (facoltativo)',
		...
		'L_MEDIAS_MAX_UPLOAD_FILE' => 'Dimensione massima dei file',
		'L_MEDIAS_MAX_UPLOAD_NBFILE' => 'Numero massimo di file per upload',
		'L_MEDIAS_MAX_POST_SIZE' => 'Dimensione massima dei dati',
		...
		'L_MEDIAS_LINK_COPYCLP' => 'Copia collegamento negli Appunti',
		'L_MEDIAS_LINK_COPYCLP_ERR' => 'Impossibile copiare il link negli appunti',
		'L_MEDIAS_LINK_COPYCLP_DONE' => 'Link copiato',
		'L_MEDIAS_NEW_NAME' => 'Nuovo nome',
		'L_MEDIAS_RENAME' => 'Rinominare',
		...
		'L_CONFIG_ADVANCED_LOSTPASSWORD' => 'Abilita il recupero della password',
		...
		'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE' => 'Invio e-mail',
		'L_CONFIG_ADVANCED_EMAIL_METHOD' => 'Metodo di invio e-mail',
		'L_CONFIG_ADVANCED_SMTP_TITLE' => 'Invio di e-mail con SMTP',
		'L_CONFIG_ADVANCED_SMTP_SERVER' => 'Nome host SMTP',
		'L_CONFIG_ADVANCED_SMTP_USERNAME' => 'Nome utente SMTP',
		'L_CONFIG_ADVANCED_SMTP_PASSWORD' => 'Password SMTP',
		'L_CONFIG_ADVANCED_SMTP_PORT' => 'Porta SMTP',
		'L_CONFIG_ADVANCED_SMTP_SECURITY' => 'Crittografia SMTP',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE' => 'Invio di e-mail con SMTP e OAUTH2',
		'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL' => 'Indirizzo email',
		...
		'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Ho bisogno di aiuto : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentazione di PluXml</a>&nbsp;(fr)',
		'L_CONFIG_ADVANCED_EMAIL_METHOD_HELP' => 'Non è richiesta alcuna configurazione per sendmail.',
		'L_CONFIG_ADVANCED_SMTP_SERVER_HELP' => 'Nome del server SMTP (esempio : ssl0.ovh.net)',
		'L_CONFIG_ADVANCED_SMTP_USERNAME_HELP' => 'Nome utente sull\'host SMTP (esempio : pluxml@monserveursmtp.com)',
		'L_CONFIG_ADVANCED_SMTP_PASSWORD_HELP' => 'Password utente sull\'host SMTP',
		'L_CONFIG_ADVANCED_SMTP_PORT_HELP' => 'Numero porta host SMTP (impostazione predefinita : 465)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'PluXml consente di generare token solo per il servizio <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Hai bisogno di aiuto per generare il nome utente e la chiave segreta : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentazione di PluXml</a>&nbsp;(fr).',
		'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL_HELP' => 'Indirizzo utilizzato sul servizio OAUTH2 (esempio : pluxml@gmail.com)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_CLIENTID_HELP' => 'ID cliente sul servizio OAUTH2 (esempio : 664335625964-uha1vop20qPluXml81ubjkkgfabbbj6d.apps.googleusercontent.com)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_SECRETKEY_HELP' => 'La chiave client sul servizio OAUTH2 (esempio : PrsvKp6aprKpoP8snnCoC8-x)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN_HELP' => 'Salvare l\'ID cliente e il codice segreto cliente in modo da poter generare il token.',
		...
		'L_MAIL_TEST' => 'Invia un\'e-mail di prova',
		'L_MAIL_TEST_SUBJECT' => 'Prova l\'e-mail inviata da %s',
		'L_MAIL_TEST_SENT_TO' => 'Prova l\'e-mail inviata a %s. Controlla la tua casella di posta',
		'L_MAIL_TEST_FAILURE' => 'Problema per l\'invio dell\'e-mail di prova',
		...
		'L_ERR_EMAIL_ALREADY_EXISTS' => 'Indirizzo email già in uso',
		...
		'L_WARNING_INSTALLATION_FILE' => 'Il file install.php è presente nella radice di PluXml.<br />Per motivi di sicurezza, è fortemente consigliata la <a class="lnkdelete" href="%s">cancellazione</a>.',
