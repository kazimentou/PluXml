...
$LANG = array(
        ...
        'L_FILE_REQUIRED' => 'Selecione um arquivo',
        'L_REPLY' => 'Resposta',
        'L_REPLY_TO' => 'Resposta',
        'L_CANCEL' => 'Cancelar',
        'L_DELETE' => 'Excluir',
        ...
        'L_DELETE_SUCCESSFUL' => 'Apagado com sucesso',
        'L_DELETE_FILE_ERR' => 'Erro ao excluir o arquivo',
        'L_RENAME_FILE_SUCCESSFUL' => 'Arquivo renomeado com sucesso',
        'L_RENAME_FILE_ERR' => 'Erro ao processar o arquivo',
        'L_RENAME_FILE' => 'Renomear arquivo',
        'L_THUMBNAIL' => 'Miniatura (facultativo)',
        ...
        'L_AUTH_LOST_FIELD' => 'Login ou endereço de e-mail',
        'L_SUBMIT_BUTTON' => 'Validar',
        'L_ERR_WRONG_PASSWORD' => 'Login ou senha incorrecta',
        'L_POWERED_BY' => 'Propulsado por: <a href="https://www.pluxml.org">PluXml</a>',
        'L_ERR_MAXLOGIN' => 'Demasiados login falhou<br />Repetir em% s minutos',
        'L_LOST_PASSWORD' => 'Senha esquecida?',
        ...
        'L_MEDIAS_LINK_COPYCLP' => 'Copy Link para área de transferência',
        'L_MEDIAS_LINK_COPYCLP_ERR' => 'Não é possível copiar o link para a área de transferência',
        ...
        'L_CONFIG_VIEW_BYPAGE_TAGS' => 'Numero de artigos por página nas tags',
        ...
        'L_CONFIG_ADVANCED_SMTP_SECURITY' => 'Criptografia SMTP',
        'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE' => 'Enviando emails com SMTP e OAUTH2',
        'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL' => 'Endereço de e-mail',
        'L_CONFIG_ADVANCED_SMTPOAUTH_CLIENTID' => 'ID do cliente',
        'L_CONFIG_ADVANCED_SMTPOAUTH_SECRETKEY' => 'Chave secreta do cliente',
        'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
        'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Gere um token',
        'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Preciso de ajuda : <a href="https://wiki.pluxml.org/personnaliser/personnalisation/#envoi-de-mails">PluXml documentation</a>&nbsp;(fr).',
        'L_CONFIG_ADVANCED_EMAIL_METHOD_HELP' => 'Nenhuma configuração é necessária para o sendmail.',
        'L_CONFIG_ADVANCED_SMTP_SERVER_HELP' => 'Nome do servidor SMTP (exemplo : ssl0.ovh.net)',
        'L_CONFIG_ADVANCED_SMTP_USERNAME_HELP' => 'Nome de usuário no host SMTP (exemplo : pluxml@monserveursmtp.com)',
        'L_CONFIG_ADVANCED_SMTP_PASSWORD_HELP' => 'Senha do usuário no host SMTP',
        'L_CONFIG_ADVANCED_SMTP_PORT_HELP' => 'Número da porta do host SMTP (padrão: 465)',
        'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'O PluXml permite gerar tokens apenas para o serviço <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Precisa de ajuda para gerar o nome de usuário e a chave secreta: <a href="https://wiki.pluxml.org/personnaliser/personnalisation/#envoi-de-mails">PluXml documentation</a>&nbsp;(fr).',
        'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL_HELP' => 'Endereço usado no serviço OAUTH2 (exemplo : pluxml@gmail.com)',
        ...
        'L_MAIL_TEST' => 'Envie um email de teste',
        ...
        'L_PLUGINS_HELP' => 'Ajudar',
        'L_PLUGINS_HELP_TITLE' => 'Consulte Usando o plugin',
        ...
        'L_PROFIL_MAIL' => 'Enderêco de e-mail',
        ...
        'L_WARNING_INSTALLATION_FILE' => 'O ficheiro install.php está presente na raíz de PluXml.<br />Por razões de segurança apague (<a class="lnkdelete" href="?del=install">delete</a>) este ficheiro.',
