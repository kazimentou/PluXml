...
$LANG = array(
		...
		'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Preciso de ajuda : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentação do PluXml</a>&nbsp;(fr)',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'O PluXml permite gerar tokens apenas para o serviço <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Precisa de ajuda para gerar o nome de usuário e a chave secreta: <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentação do PluXml</a>&nbsp;(fr).',
