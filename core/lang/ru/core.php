...
const L_ERR_FILE_NOTFOUND			= 'Файл не найден';
...
const L_ARTFEED_RSS_CATEGORY		= 'RSS-поток категорий';
const L_ARTFEED_RSS_TAG				= 'RSS-поток статей в этом теге';
...
const L_PAGINATION_FIRST			= '&laquo;';
