...
$LANG = array(
		...
		'L_FILE_REQUIRED' => 'Vă rugăm să selectaţi un fişier',
		'L_REPLY' => 'Răspuns',
		'L_REPLY_TO' => 'Răspuns',
		'L_CANCEL' => 'Anulare',
		'L_DELETE' => 'Şterge',
		...
		'L_MEDIAS_LINK_COPYCLP' => 'Copiați linkul în clipboard',
		'L_MEDIAS_LINK_COPYCLP_ERR' => 'Imposibil de copiat link-ul în clipboard',
		...
		'L_CONFIG_VIEW_BYPAGE_TAGS' => 'Numărul de articole pe pagină în etichetele',
		...
		'L_CONFIG_ADVANCED_SMTP_SECURITY' => 'Criptare SMTP',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE' => 'Trimiterea de e-mailuri cu SMTP și OAUTH2',
		'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL' => 'Adresa de email',
		...
		'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Nevoie de ajutor : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentația PluXml</a>&nbsp;(fr)',
		'L_CONFIG_ADVANCED_EMAIL_METHOD_HELP' => 'Nicio configurație nu este necesară pentru sendmail.',
		'L_CONFIG_ADVANCED_SMTP_SERVER_HELP' => 'Nume server SMTP (exemplu : ssl0.ovh.net)',
		'L_CONFIG_ADVANCED_SMTP_USERNAME_HELP' => 'Numele de utilizator pe gazda SMTP (exemplu : pluxml@monserveursmtp.com)',
		'L_CONFIG_ADVANCED_SMTP_PASSWORD_HELP' => 'Parolă de utilizator pe gazda SMTP',
		'L_CONFIG_ADVANCED_SMTP_PORT_HELP' => 'Numărul portului gazdă SMTP (implicit: 465)',
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'PluXml permite generarea de jetoane numai pentru serviciu <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Aveți nevoie de ajutor pentru a genera numele de utilizator și cheia secretă : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentația PluXml</a>&nbsp;(fr).',
		'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL_HELP' => 'Adresa folosită pe serviciul OAUTH2 (exemplu : pluxml@gmail.com)',
		...
		'L_MAIL_TEST' => 'Trimiteți un e-mail de testare',
