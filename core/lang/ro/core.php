...
const L_ARTFEED_RSS_CATEGORY		= 'RSS Feed Elementele din această categorie';
const L_ARTFEED_RSS_TAG				= 'RSS Feed Elementele din această etichetă';
