...
const L_FILE_REQUIRED = 'Elixe un arquivo';
...
const L_RENAME_FILE_ERR = 'Erro ó procesar o arquivo';
const L_RENAME_FILE = 'Renomear arquivo';
const L_THUMBNAIL = 'Miniatura (opcional)';
const L_THUMBNAIL_SELECTION = 'Seleccionar Imaxe';
const L_THUMBNAIL_TITLE = 'Título da imaxe (opcional)';
const L_THUMBNAIL_ALT = 'Texto alternativo da imaxe (opcional)';
const L_ERR_INVALID_DATE_CREATION = 'Data de creación non válida';
const L_ERR_INVALID_DATE_UPDATE = 'Data actualización non válida';

// class.plx.admin.php

const L_SAVE_SUCCESSFUL = 'Gardáronse os datos correctamente';
const L_SAVE_ERR = 'Erro ó gardar os datos';
const L_NO_ENTRY = 'Acceso denegado';
const L_ERR_USER_EMPTY = 'Introduce un nome de usuario';
const L_ERR_PASSWORD_EMPTY = 'Introduce un contrasinal';
const L_ERR_PASSWORD_EMPTY_CONFIRMATION = 'Contrasinal incorrecta ou valeira';
const L_ERR_INVALID_EMAIL = 'Dirección de correo incorrecta';
const L_ERR_INVALID_SITE = 'URL de sitio incorrecta';
const L_ERR_INVALID_ARTICLE_IDENT = 'Identificador de artigo incorrecto!';
const L_DEFAULT_NEW_CATEGORY_URL = 'nova-categoria';
const L_DEFAULT_NEW_STATIC_URL = 'nova-paxina';
const L_DEFAULT_NEW_ARTICLE_URL = 'novo-artigo';
const L_ARTICLE_SAVE_SUCCESSFUL = 'Artígo creado correctamente';
const L_ARTICLE_MODIFY_SUCCESSFUL = 'Artígo actualizado correctamente';
const L_ARTICLE_DELETE_SUCCESSFUL = 'Artígo eliminado correctamente';
...
const L_PLXMEDIAS_DELETE_FILES_ERR = 'Erro ó eliminar un archivo';
const L_PLXMEDIAS_DELETE_FILE_SUCCESSFUL = 'Archivo eliminado correctamente';
const L_PLXMEDIAS_DELETE_FILE_ERR = 'Erro ó eliminar o arquivo';
...
const L_PLXMEDIAS_NEW_FOLDER_ERR = 'Non se puido crear o cartafol';
const L_PLXMEDIAS_NEW_FOLDER_SUCCESSFUL = 'Cartafol creado correctamente';
const L_PLXMEDIAS_NEW_FOLDER_EXISTS = 'Este cartafol xa existe';
const L_PLXMEDIAS_WRONG_FILESIZE = 'O tamaño dun arquivo é superior a:';
const L_PLXMEDIAS_WRONG_FILEFORMAT = 'O tipo de arqiivo non está permitido';
const L_PLXMEDIAS_UPLOAD_ERR = 'Erro ó subir un arquivo';
const L_PLXMEDIAS_UPLOAD_SUCCESSFUL = 'Arquivo subido correctamente';
const L_PLXMEDIAS_UPLOADS_ERR = 'Erro ó subir arquivos';
const L_PLXMEDIAS_UPLOADS_SUCCESSFUL = 'Arquivos subidos correctamente';
const L_PLXMEDIAS_MOVE_FILES_SUCCESSFUL = 'Arquivos movidos correctamente';
const L_PLXMEDIAS_MOVE_FILE_SUCCESSFUL = 'Arquivo movido correctamente';
const L_PLXMEDIAS_MOVE_FILES_ERR = 'Erro ó mover os arquivos';
const L_PLXMEDIAS_MOVE_FILE_ERR = 'Erro ó mover o arquivo';
const L_PLXMEDIAS_MOVE_FOLDER = 'Mover';
const L_PLXMEDIAS_RECREATE_THUMB_ERR = 'Erro ó crear a miniatura';
const L_PLXMEDIAS_RECREATE_THUMBS_ERR = 'Erro ó crear as miniaturas';
...
const L_ARTICLE_LIST_AUTHORS = 'Autor';
const L_HEADLINE_FIELD = 'Subtítulo (opcional)';
const L_CONTENT_FIELD = 'Contido';
const L_LINK_FIELD = 'Ligazçon ço artigo';
const L_LINK_ACCESS = 'Ir ó artigo';
...
const L_ARTICLE_DATE = 'Data de publicación';
const L_NOW = 'agora';
const L_ARTICLE_CATEGORIES = 'Categorías';
const L_ARTICLE_TAGS_FIELD = 'Etiquetas';
const L_ARTICLE_TAGS_FIELD_TITLE = 'Separa as etiquetas con comas';
const L_ARTICLE_TOGGLER_TITLE = 'Lista de etiquetas';
const L_NO_TAG = 'Ningunha etiqueta';
const L_ALLOW_COMMENTS = 'Permitir comentarios';
const L_ARTICLE_URL_FIELD = 'URL';
const L_ARTICLE_URL_FIELD_TITLE = 'A URL énchese automáticamente durante a creación';
const L_ARTICLE_TEMPLATE_FIELD = 'Plantilla';
const L_ARTICLE_MANAGE_COMMENTS = 'Moderar os comentarios';
const L_ARTICLE_MANAGE_COMMENTS_TITLE = 'Moderar os comentarios deste artigo';
const L_ARTICLE_NEW_COMMENT = 'Escribir un comentario';
const L_ARTICLE_NEW_COMMENT_TITLE = 'Escribir un comentario sobre este artigo';
const L_ARTICLE_DELETE_CONFIRM = 'Eliminar este artigo?';
...
const L_AUTH_PAGE_TITLE = 'Paxina de autenticación';
const L_LOGOUT_SUCCESSFUL = 'Sesión finalizada correctamente';
...
const L_SORT_ASCENDING_DATE = 'máis antigo a máis recente';
const L_SORT_DESCENDING_DATE = 'máis recente a máis antigo';
...
const L_CAT_TITLE = 'Xestor de categorías';
const L_ACTIVE = 'Activa';
const L_CAT_LIST_NAME = 'Nome da categoría';
const L_URL = 'URL';
...
const L_NEW_CATEGORY = 'Nova categoría';
...
const L_EDITCAT_PAGE_TITLE = 'Editar opcións de categoría';
...
const L_COMMENT_DATE_FIELD = 'Data e hora de publicación';
...
const L_COMMENT_LINKED_ARTICLE_FIELD = 'Artigo asociado';
...
const L_ERR_COMMENT_UNKNOWN_ARTICLE = 'É imposible comentar nun artigo que non existe!';
const L_ERR_CREATING_COMMENT = 'Erro grave durante a creación do comentario';
...
const L_COMMENTS_LIST_MESSAGE = 'Mensaxe';
const L_COMMENTS_LIST_ACTION = 'Acción';
...
const L_COMMENTS_PRIVATE_FEEDS = 'Sindicacións RSS privadas';
const L_COMMENTS_ONLINE_LIST = 'Lista de revisións publicadas';
...
const L_SEARCH = 'Busca';
const L_SEARCH_PLACEHOLDER = 'identificador ou título';
const L_ARTICLES_ALL_CATEGORIES = 'Tódalas categorías...';
const L_ALL = 'Todos';
...
const L_MEDIAS_FILENAME = 'Nome do arquivo';
const L_MEDIAS_TITLE = 'Xestión de medios';
...
const L_MEDIAS_ADD_FILE = 'Agregar arquivo';
const L_MEDIAS_DELETE_FOLDER_CONFIRM = 'Desexas eliminar o cartafol %s e o seu contido?';
const L_MEDIAS_FOLDER = 'Arquivo';
const L_MEDIAS_NEW_FOLDER = 'Nova cartafol';
const L_MEDIAS_CREATE_FOLDER = 'Crear un cartafol';
const L_MEDIAS_FILESIZE = 'Tamaño';
const L_DATE = 'Data';
const L_MEDIAS_DIMENSIONS = 'Dimensións';
const L_MEDIAS_NO_FILE = 'Sen arquivos';
const L_MEDIAS_RESIZE = 'Cambiar o tamaño das imaxes';
const L_MEDIAS_RESIZE_NO = 'Tamaño orixinal';
const L_MEDIAS_THUMBS = 'Crear miniaturas';
const L_MEDIAS_THUMBS_NONE = 'Sen miniatura';
...
const L_MEDIAS_RECREATE_THUMB = 'Crear miniatura novamente';
const L_MEDIAS_LINK_COPYCLP = 'Copiar ligazón no portapapeis';
const L_MEDIAS_LINK_COPYCLP_ERR = 'Non se pode copiar a ligazón no portapapeis';
...
const L_CONFIG_VIEW_BYPAGE_ADMIN = 'Cantidade de artigos por paxina na paxina de administración';
const L_CONFIG_VIEW_SORT_COMS = 'Ordear comentarios';
const L_CONFIG_VIEW_BYPAGE_ADMIN_COMS = 'Cantidade de comentarios por paxina na paxina de administración';
const L_CONFIG_VIEW_IMAGES = 'Tamaño da imaxe (alto x ancho)';
const L_CONFIG_VIEW_THUMBS = 'Tamaño das miniaturas (alto x ancho)';
const L_CONFIG_VIEW_HOMESTATIC = 'Utilizar unha paxina estática como paxina de inicio';
const L_CONFIG_VIEW_HOMESTATIC_ACTIVE = 'Advertencia: esta paxina está desactivada';
const L_CONFIG_VIEW_PLUXML_RESSOURCES = 'Descargar outros temas en <a href="http://ressources.pluxml.org">ressources.pluxml.org</a>.';
const L_CONFIG_VIEW_BYPAGE_FEEDS = 'Cantidade de artigos na sindicación RSS';
const L_CONFIG_VIEW_FEEDS_HEADLINE = 'Cómo mostrar subtítulos na sindicación RSS dos artigos';
const L_CONFIG_VIEW_FEEDS_HEADLINE_HELP = 'No caso de que o subtítulo esté baleiro, se mostrará o contido';
const L_CONFIG_VIEW_FEEDS_FOOTER = 'Texto ó final de cada artigo na sindicación RSS';
const L_CONFIG_VIEW_UPDATE = 'Gardar opcións de visualización';
const L_CONFIG_VIEW_DISPLAY_EMPTY_CAT = 'Mostrar categorías sen artigos';
const L_CONFIG_HOMETEMPLATE = 'Plantilla da paxina principal';
...
const L_CONFIG_ADVANCED_LOSTPASSWORD = 'Habilitar recuperación de contrasinal';
...
const L_HELP_SLASH_END = 'Non esquecer a barra ó final';
...
const L_CONFIG_ADVANCED_STATS_FOLDER = 'Ubicación do cartafol de paxinas éstaticas';
const L_CONFIG_ADVANCED_THEMES_FOLDER = 'Ubicación do cartafol de temas';
const L_CONFIG_ADVANCED_PLUGINS_FOLDER = 'Ubicación do cartafol de complementos';
...
const L_CONFIG_ADVANCED_SMTP_SERVER = 'Nome de host SMTP';
const L_CONFIG_ADVANCED_SMTP_USERNAME = 'Nome de usuario SMTP';
const L_CONFIG_ADVANCED_SMTP_PASSWORD = 'Contrasinal SMTP';
...
const L_CONFIG_META_DESCRIPTION = 'Contido da metaetiqueta de descricion («description», opcional)';
const L_CONFIG_META_KEYWORDS = 'Contido da metaetiqueta de palabras chave («keywords», opcional)';
const L_CONFIG_BASE_ENABLE_RSS = 'Mostrar canles RSS';

// parametres_edittpl.php

const L_CONFIG_EDITTPL_ERROR_NOTHEME = 'Non existe o tema!';
const L_CONFIG_EDITTPL_TITLE = 'Edición do tema';
const L_CONFIG_EDITTPL_SELECT_FILE = 'Selecciona un arquivo para editar:';
const L_CONFIG_EDITTPL_LOAD = 'Cargar';

// parametres_infos.php

const L_CONFIG_INFOS_TITLE = 'Información sobre PluXml';
const L_CONFIG_INFOS_DESCRIPTION = 'Información sobre a instalación de PluXml, pode ser útil para diagnosticar problemas.';
const L_CONFIG_INFOS_NB_CATS = 'Cantidade de categorías:';
const L_CONFIG_INFOS_NB_STATICS = 'Cantidade de paxinas estáticas:';
const L_CONFIG_INFOS_WRITER = 'Cantidade de usuarios en sesión:';
const L_PLUXML_CHECK_VERSION = 'Comprobación da versión de PluXml no sitio oficial PluXml.org';
const L_PLUXML_UPDATE_UNAVAILABLE = 'É imposible comprobar as actualizacións dispoñibles si a función «allow_url_fopen» está desactivada neste sistema';
const L_PLUXML_UPDATE_ERR = 'Fallou a comprobación de actualizacións por unha razón descoñecida';
const L_PLUXML_UPTODATE = 'Está utilizando a última versión de PluXml';
const L_PLUXML_UPDATE_AVAILABLE = 'Existe unha nova versión de PluXml! Pode descargarla desde';
const L_MAIL_TEST = 'Enviar un correo-e de proba';
const L_MAIL_TEST_SUBJECT = 'Correo-e de proba enviado desde %s';
const L_MAIL_TEST_SENT_TO = 'Correo-e de proba enviado a %s. Revisa o teu correo';
const L_MAIL_TEST_FAILURE = 'Problema para enviar correo-e de proba';
...
const L_ERR_USERNAME_ALREADY_EXISTS = 'Xa existe un usuario con ese nome';
const L_ERR_EMAIL_ALREADY_EXISTS = 'Dirección de correo-e xa en uso';

// parametre_plugins.php

const L_BACK_TO_PLUGINS = 'Volver á paxina de complementos';
const L_NO_PLUGIN = 'Ningún complemento';
const L_PLUGIN_NO_CONFIG = 'Complemento sin configuración';
const L_PLUGINS_CSS = 'Código CSS';
const L_PLUGINS_CSS_TITLE = 'Editar o código CSS do complemento';
const L_CONTENT_FIELD_FRONTEND = 'Contido do arquivo de código CSS para o sitio web';
const L_CONTENT_FIELD_BACKEND = 'Contido do arquivo de código CSS para o sitio de administración';

// parametres_plugins.php

const L_PLUGINS_TITLE = 'Xestión de complementos';
...
const L_PLUGINS_APPLY_BUTTON = 'Modificar a lista de complementos';
...
const L_PROFIL_USER = 'Nome de usuario';
...
const L_STATIC_BACK_TO_PAGE = 'Volver á lista de paxinas estáticas';
const L_STATIC_UNKNOWN_PAGE = 'Non existe esta paxina estática!';
const L_STATIC_TITLE = 'Editar código fonte da paxina estática';
const L_STATIC_VIEW_PAGE = 'Visualizar paxina';
...
const L_STATICS_PAGE_TITLE = 'Crear e editar paxinas estáticas';
const L_STATICS_GROUP = 'Grupo';
const L_STATICS_URL = 'URL';
const L_STATICS_PAGE_HOME = 'Establecer como paxina de inicio';
const L_PAGE = 'Paxina';
...
const L_MENU_CONFIG_VIEW_TITLE = 'Editar opcións de visualización de PluXml';
const L_MENU_CONFIG_VIEW = 'Opcións de visualización';
...
const L_THEMES_TITLE = 'Xestión de temas';
const L_HELP = 'Axuda';
