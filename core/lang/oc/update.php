...
'L_UPDATE_WARNING2'					=> 'Se vòstra anciana version es pas listada aicí, es qu\'existís pas cap de procedura automatizada de mesa a jorn car vòstra version es tròp vièlha.<br />Vos prepausam de telecargar la darrièra version de <a href="https://www.pluxml.org">PluXml</a> e de realizar una nòva installacion.',
'L_UPDATE_WARNING3'					=> 'Atencion, abans d\'amodar la mesa a jorn, oblidetz pas de far una salvagarda de vòstras donadas en fasent une còpia del dorsièr "%s"',
...
'L_UPDATE_CREATE_USERS_FILE'		=> 'Creacion del fichièr dels utilizaires',
'L_UPDATE_ERR_CREATE_USERS_FILE'	=> 'Error pendent la creacion del fichièr dels utilizaires',
'L_UPDATE_USERS_MIGRATION'			=> 'Migracion del fichièr dels utilizaires',
'L_UPDATE_ERR_USERS_MIGRATION'		=> 'Error pendent la migracion del fichièr dels utilizaires',
'L_UPDATE_ERR_NO_USERS'				=> 'Pas cap d\'utilizaire present dins lo fichièr',
