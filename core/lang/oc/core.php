...
const L_ARTFEED_RSS_CATEGORY		= 'Fil Rss dels articles categoria %s';
const L_ARTFEED_RSS_USER			= 'Fil Rss dels articles autor %s';
const L_ARTFEED_RSS_TAG				= 'Fil Rss dels articles mot clau %s';
...
const L_ARCHIVES_URL = 'archius';
const L_BLOG_URL = 'blog';
const L_COMMENTS_URL = 'commentari';
