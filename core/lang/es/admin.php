...
$LANG = array(
        ...
        'L_FILE_REQUIRED' => 'Elija un archivo',
        ...
        'L_POWERED_BY' => 'Generado con <a href="https://www.pluxml.org">PluXml</a>',
        ...
        'L_ARTICLES_ALL_AUTHORS'	=> 'Todos los autores...',
        'L_ALL' => 'Todos',
        ...
        'L_MEDIAS_MAX_UPLOAD_FILE' => 'Tamaño máximo de archivo',
        'L_MEDIAS_MAX_UPLOAD_NBFILE' => 'Número máximo de archivos por carga',
        ...
        'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE' => 'Envío de correo electrónico',
        'L_CONFIG_ADVANCED_EMAIL_METHOD' => 'E-mail sending methodMétodo de envío de correo electrónico',
        'L_CONFIG_ADVANCED_SMTP_TITLE' => 'Envío de correos electrónicos con SMTP',
        ...
        'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE' => 'Sending emails with SMTP and OAUTH2Envío de correos electrónicos con SMTP y OAUTH2',
        'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL' => 'Dirección de correo electrónico',
        'L_CONFIG_ADVANCED_SMTPOAUTH_CLIENTID' => 'ID cliente',
        'L_CONFIG_ADVANCED_SMTPOAUTH_SECRETKEY' => 'Clave secreta del cliente',
        'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN' => 'Token',
        'L_CONFIG_ADVANCED_SMTPOAUTH_GETTOKEN' => 'Generar un token',
        'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Necesitas ayuda : <a href="https://wiki.pluxml.org/personnaliser/personnalisation/#envoi-de-mails">PluXml documentation</a>&nbsp;(fr).',
        'L_CONFIG_ADVANCED_EMAIL_METHOD_HELP' => 'No se requiere configuración para sendmail.',
        'L_CONFIG_ADVANCED_SMTP_SERVER_HELP' => 'Nombre del servidor SMTP (ejemplo: ssl0.ovh.net)',
        'L_CONFIG_ADVANCED_SMTP_USERNAME_HELP' => 'Nombre de usuario en el host SMTP (ejemplo : pluxml@monserveursmtp.com)',
        'L_CONFIG_ADVANCED_SMTP_PASSWORD_HELP' => 'Contraseña de usuario en el host SMTP',
        'L_CONFIG_ADVANCED_SMTP_PORT_HELP' => 'Número de puerto del host SMTP (predeterminado : 465)',
        'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'PluXml permite generar tokens solo para el servicio <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Necesita ayuda para generar el nombre de usuario y la clave secreta : <a href="https://wiki.pluxml.org/personnaliser/personnalisation/#envoi-de-mails">PluXml documentation</a>&nbsp;(fr).',
        'L_CONFIG_ADVANCED_SMTPOAUTH_EMAIL_HELP' => 'Dirección utilizada en el servicio OAUTH2 (ejemplo: pluxml@gmail.com)',
        'L_CONFIG_ADVANCED_SMTPOAUTH_CLIENTID_HELP' => 'ID de cliente en el servicio OAUTH2 (ejemplo : 664335625964-uha1vop20qPluXml81ubjkkgfabbbj6d.apps.googleusercontent.com)',
        'L_CONFIG_ADVANCED_SMTPOAUTH_SECRETKEY_HELP' => 'La clave del cliente en el servicio OAUTH2 (ejemplo : PrsvKp6aprKpoP8snnCoC8-x)',
        'L_CONFIG_ADVANCED_SMTPOAUTH_TOKEN_HELP' => 'Guarde la identificación del cliente y el código secreto del cliente para que pueda generar el token.',
        ...
        'L_MAIL_TEST' => 'Enviar un correo electrónico de prueba',
        'L_MAIL_TEST_SUBJECT' => 'Correo electrónico de prueba enviado desde %s',
        'L_MAIL_TEST_SENT_TO' => 'Correo electrónico de prueba enviado a %s. Revisa tu correo',
        'L_MAIL_TEST_FAILURE' => 'Problema para enviar el correo electrónico de prueba',
        ...
        'L_WARNING_INSTALLATION_FILE' => 'Todavía existe el archivo «install.php» en la raíz de PluXml.<br />Por razones de seguridad, le sugerimos que lo <a class="lnkdelete" href="?del=install">elimine</a>.',
