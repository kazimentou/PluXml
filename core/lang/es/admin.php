...
$LANG = array(
		...
		'L_CONFIG_ADVANCED_EMAIL_SENDING_TITLE_HELP' => 'Necesitas ayuda : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentación de PluXml</a>&nbsp;(fr)',
		...
		'L_CONFIG_ADVANCED_SMTPOAUTH_TITLE_HELP' => 'PluXml permite generar tokens solo para el servicio <a href="https://cloud.google.com">GMAIL (Google)</a>.<br>Necesita ayuda para generar el nombre de usuario y la clave secreta : <a href="https://wiki.pluxml.org/docs/customize/advancedconfig.html?highlight=smtp#envoi-d-e-mails">Documentación de PluXml</a>&nbsp;(fr).',
