...
const L_SHORT_APRIL					= 'avril';
const L_SHORT_MAY					= 'mai';
const L_SHORT_JUNE					= 'juin';
const L_SHORT_JULY					= 'juil';
const L_SHORT_AUGUST				= 'août';
...
const L_ARTTAGS_NONE				= 'aucun';
const L_ARTCHAPO					= 'Lire la suite de #art_title';
const L_ARTFEED_RSS_CATEGORY		= 'Fil RSS des articles de la catégorie %s';
const L_ARTFEED_RSS_USER			= 'Fil RSS des articles publiés par %s';
const L_ARTFEED_RSS_TAG				= 'Fil RSS des articles pour le mot-clé %s';
...
const L_SAID						= 'a dit';
const L_PAGINATION_FIRST_TITLE		= 'Première page';
...
const L_PAGINATION_LAST_TITLE		= 'Dernière page';
const L_PAGINATION_LAST				= '⏩';
const L_PAGINATION					= 'page %d / %d';
