...
<form method="post" id="form_advanced_settings" class="first-level">
    <div class="adminheader">
        ...
        <div>
			<button name="config-more" class="btn--primary" role="button"><?= L_SAVE ?></button>
        </div>
    </div>
<?php
# Hook Plugins
...
foreach(array(
	...
	'clef'					=> array(false,	L_CONFIG_ADVANCED_ADMIN_KEY, L_CONFIG_ADVANCED_KEY_HELP),
	...
	'racine_plugins'		=> array(false,	L_CONFIG_ADVANCED_PLUGINS_FOLDER, L_SLASH_END_REQUIRED),
