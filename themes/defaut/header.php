...
const MENU_TEMPLATE = '<li class="#static_class #static_status" id="#static_id"><a href="#static_url" title="#static_name">#static_name</a></li>';
			...
			<div>
				...
				<nav class="nav">
					...
					<div class="responsive-menu">
						...
						<ul class="menu">
							<?php $plxShow->staticList($plxShow->getLang('HOME'), MENU_TEMPLATE); ?>
